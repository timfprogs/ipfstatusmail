...
'VersioneTxt' => 'Allineato alla versione 156.01',
'24 hours' => '24 Hours',
'Act as' => 'Lavora come:',
...
'Captive' => 'Portale Captive',
'Captive 1day' => '1 Giorno',
'Captive 1month' => '1 Mese',
'Captive 1week' => '1 Settimana',
'Captive GAIN ACCESS' => 'GAIN ACCESS',
'Captive WiFi coupon' => 'Coupon per WiFi',
'Captive activate' => 'Attivare',
'Captive activated' => 'Attivato',
'Captive active on' => 'Attivato il',
'Captive agree tac' => 'Sono d\'accordo con i termini e le condizioni d\’utilizzo.',
'Captive auth_lic' => 'Licenza',
'Captive auth_vou' => 'Coupon',
'Captive authentication' => 'Tipo di accesso',
'Captive brand color' => 'Colore del marchio',
'Captive branding' => 'Marchio',
'Captive client session expiry time' => 'Ora di scadenza della sessione',
'Captive config' => 'Settings',
'Captive coupon' => 'Coupon',
'Captive delete logo' => 'Cancella Logo',
'Captive err doublevoucher' => 'Esiste già un coupon con questo codice',
'Captive expire' => 'Scadenza',
'Captive expiry time' => 'Tempo di scadenza ',
'Captive export coupons' => 'Coupon di esportato',
'Captive generate coupons' => 'Genera Coupons',
'Captive generated coupon no' => 'Numero di coupons',
'Captive heading terms' => 'Termini &amp; Condizioni',
'Captive heading voucher' => 'Codice d\'accesso per il Coupon',
'Captive invalid coupon' => 'Hai inserito un codice coupon non valido. Per favore riprova.',
'Captive invalid logosize' => 'Il file immagine caricato non soddisfa i requisiti, la risoluzione deve essere di almeno 1280 x 400 ma non superiore a 1920 x 800 pixel ',
'Captive invalid_voucher' => 'Codice non VALIDO. Per favore riprova',
'Captive ip' => 'Indirizzo IP',
'Captive issued coupons' => 'Coupons Emesso',
'Captive logo uploaded' => 'Logo uploaded',
'Captive logo_set' => 'Current Logo',
'Captive mac' => 'MAC Address',
'Captive noexpiretime' => 'NON è stato indicato un intervallo di tempo valido per la connessione',
'Captive nolimit' => 'illimitata',
'Captive nr' => 'Numero',
'Captive please accept the terms and conditions' => 'Accetta i le condizioni  &amp; termini',
'Captive please enter a coupon code' => 'Inserire un codice coupon',
'Captive portal' => 'Portale Captive di IPFire',
'Captive portal coupons' => 'Captive Portal Coupons',
'Captive terms' => 'Termini &amp; condizioni',
'Captive terms short' => 'T&Cs',
'Captive time' => 'Orario di accesso dopo l\'attivazione (ore)',
'Captive title' => 'Titolo della pagina di accesso ',
'Captive upload logo' => 'Upload Logo',
'Captive upload logo raccomandazioni' => '(PNG or JPEG, raccomandata 1280x720 pixels)',
'Captive valid for' => 'Valido per',
'Captive voactive' => 'Coupons attivi',
'Captive voucher' => 'Coupon',
'Captive vouchervalid' => 'Tempo consentito per questo coupon',
'Captive vout' => 'Buoni emessi',
'Captive wrong ext' => 'Il file caricato è un tipo di file errato ',
...
'ConnSched scheduled actions' => 'AzioneSchedula',
...
'ConnSched sendmail' => 'Log per email',
'Daily' => 'Giornaliero',
...
'Number of Countries for the pie chart' => 'Numero di paesi per il grafico a torta',
...
'advproxy NTLM authorized users' => 'Authorized domain users (uno per riga)',
'advproxy NTLM domain' => 'Domain',
'advproxy NTLM domain settings' => 'Common domain settings',
'advproxy NTLM unauthorized users' => 'Unauthorized domain users (uno per riga)',
'advproxy NTLM use integrated auth' => 'Abilita Windows integrated authentication',
...
'advproxy RADIUS authorized users' => 'Utenti autorizzati (uno per riga)',
...
'advproxy RADIUS unauthorized users' => 'Utenti non autorizzati (uno per riga)',
...
'eg' => 'e.g.:',
'eight hours' => '8 Hours',
'email config' => 'Configurazione',
'email empty field' => 'Empty field',
'email error' => 'ERRORE: non è stato possibile inviare l\'email di prova',
'email invalid' => 'Campo non valido',
'email invalid mailfqdn' => 'Server di posta non valido fqdn',
'email invalid mailip' => 'Indirizzo IP del server di posta non valido',
'email invalid mailport' => 'Porta del server di posta non valida',
'email mailaddr' => 'Indirizzo del server mail',
'email mailpass' => 'Password',
'email mailport' => 'Porta del server mail',
'email mailrcpt' => 'Destinatario',
'email mailsender' => 'Mittente',
...
'email usemail' => 'Attiva il servizio mail',
...
'enable smt' => 'Abilita multithreading simultaneo (SMT)',
...
'legacy architecture warning' => 'Stai eseguendo IPFire su un\'architettura legacy, si consiglia di eseguire l\'aggiornamento',
'legend' => 'Legenda',
'length' => 'Length',
'lifetime' => 'Lifetime:',
'line' => 'Line',
...
'priority' => 'Priorità',
'processes' => 'Processi',
'processor vulnerability mitigations' => 'vulnerabilità del processore',
'profile' => 'Profilo',
...
'proxy reports weekly' => 'Report settimanale',
'psk' => 'PSK',
'ptr' => 'PTR',
...
'smbstop' => 'Stop samba',
'smt disabled' => 'Il multithreading simultaneo (SMT) è disabilitato',
'smt enabled' => 'Il multithreading simultaneo (SMT) è abilitato',
'smt not supported' => 'Il multithreading simultaneo (SMT) non è sopportato',
'smtphost' => 'SMTP host',
'smtpport' => 'SMTP port',
...
'tor accounting period weekly' => 'Settimanale',
...
'updxlrtr 3 months' => 'Tre mesi',
'updxlrtr 6 months' => 'Sei mesi',
'updxlrtr all files' => 'Tutti i file ...',
'updxlrtr cache dir' => 'Cache directory',
'updxlrtr cache maintenance' => 'Manuntenzione Cache',
'updxlrtr cache size' => 'Cache size (bytes)',
'updxlrtr cache statistics' => 'Statistica Cache',
'updxlrtr cancel download' => 'Cancela download',
...
'updxlrtr enable autocheck' => 'Abilita il controllo automatico della fonte',
'updxlrtr enable log' => 'Abilita log',
'updxlrtr filename' => 'Name',
'updxlrtr files' => 'Files',
'updxlrtr filesize' => 'Size',
'updxlrtr full autosync' => 'Sostituisci i file obsoleti durante il controllo',
...
'updxlrtr maintenance' => 'Manuntenzione',
'updxlrtr marked as' => 'marked as',
'updxlrtr max disk usage' => 'Max. disk usage',
'updxlrtr max download rate' => 'Max. velocità di download (kbit / s)',
'updxlrtr month' => 'Un mese',
...
'updxlrtr passive mode' => 'Notifica senza consegna / senza download: ',
'updxlrtr pending downloads' => 'Download in attesa',
'updxlrtr performance options' => 'Opzioni di performance',
'updxlrtr progress' => 'Avanzamento',
...
'updxlrtr source checkup schedule' => 'Pianificazione dei sorgenti ',
'updxlrtr sources' => 'Sources',
'updxlrtr standard view' => 'Standard view',
'updxlrtr statistics' => 'Statistiche',
'updxlrtr statistics by source' => 'Statistica dei sorgenti',
...
'updxlrtr week' => 'una settimana ',
'updxlrtr weekly' => 'settimanalmente',
'updxlrtr year' => 'Un anno',
'upgrade' => 'upgrade',
'uplink' => 'Uplink',
...
'urlfilter category' => 'Categoria',
'urlfilter category all' => 'qualunque',
...
'urlfilter constraint outside' => 'al di fuori',
'urlfilter constraint within' => 'entro',
'urlfilter copy rule' => 'Copia',
...
'urlfilter disabled' => 'disabilitato',
'urlfilter domains' => 'Domini (uno per linea)',
...
'urlfilter expressions' => 'Espressione (una per linea)',
...
'urlfilter from' => 'Da',
'urlfilter hourly' => 'ogni ora',
'urlfilter import blacklist' => 'Impo blacklist',
'urlfilter import text' => 'To import a previously saved blacklist editor file upload the .tar.gz file below',
'urlfilter install blacklist' => 'Installa blacklist',
...
'urlfilter invalid user error' => 'username non valido',
'urlfilter load blacklist' => 'Carica blacklist',
...
'urlfilter minutes' => 'minuti',
'urlfilter mode allow' => 'permettere',
'urlfilter mode block' => 'bloccare',
'urlfilter mon' => 'M',
...
'urlfilter restore success' => 'La configurazione del filtro URL è stata ripristinata. Il filtro URL deve essere riavviato per attivare le nuove impostazioni .',
...
'urlfilter save and restart' => 'Salva e riavvia',
'urlfilter save schedule' => 'Salva e aggiorna configurazione',
'urlfilter select blacklist' => 'Seleziona la lista nera',
'urlfilter select multi' => 'Premere il tasto ctrl per selezionare più categorie',
...
'year' => 'Anno',
'year-graph' => 'Anno',
'yearly firewallhits' => 'accessi annuali al firewall ',
'yes' => 'Si',
...
'zoneconf access none' => 'Nessuno',
'zoneconf access vlan' => 'VLAN',
'zoneconf nic assignment' => 'Assegnamento NIC',
'zoneconf nicmode bridge' => 'Bridge',
'zoneconf nicmode default' => 'Default',
'zoneconf nicmode macvtap' => 'MacVTap',
'zoneconf notice reboot' => 'Esegui il riavvio per applicare i cambiamenti.',
'zoneconf stp enable' => 'Abilita STP',
'zoneconf stp priority' => 'Priorita\’ Bridge',
'zoneconf title' => 'Configurazione Zona',
'zoneconf val native assignment error' => 'Non e\’ possibile accedere a una NIC in modo nativo da piu\’ di una zona.',
'zoneconf val ppp assignment error' => 'La NIC usata per la RED in modalita\’ PPP non e\’ accessibile da nessun\'altra zona.',
'zoneconf val stp priority range error' => 'La priorita\’ del bridge STP deve essere compresa tra 1 e 65535',
'zoneconf val stp zone mode error' => 'STP puo\’ essere abilitato solo se la zona e\’ in modalita\’ bridge',
'zoneconf val vlan amount assignment error' => 'Una zona non può avere piu\’ di una VLAN assegnata.',
'zoneconf val vlan tag assignment error' => 'Non e\’ possibile utilizzare lo stesso tag VLAN piu\’ di una volta per NIC.',
'zoneconf val zoneslave amount error' => 'Una zona non in modalità bridge non puo\’ avere piu\’ di una NIC assegnata',
);
